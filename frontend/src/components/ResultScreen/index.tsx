  ...
  return (
    <div className="mx-auto my-8 w-[90%] max-w-[900px] p-10 md:my-14 md:w-auto md:p-0">
      <div className="mb-8 text-center md:mb-12">
        <div className="text-6xl font-bold text-theme-color">🃏</div>
        <h1 className="text-3xl font-bold text-theme-color mt-4">Poker Theory Practice</h1>
        <p className="text-lg text-gray-600 dark:text-gray-300 mt-2">Quiz Results</p>
      </div>
